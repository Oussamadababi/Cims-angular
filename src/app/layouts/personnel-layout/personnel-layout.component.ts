...
@Component({
  ...
  styleUrls: ["./personnel-layout.component.css"]
})
export class PersonnelLayoutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.isLoggedIn) {
      ...
      this.showPERSONNELBoard = this.roles.includes("ROLE_PERSONNEL");

      this.username = user.username;
    }*/
    this.userService.getPersonnelBoard().subscribe(
      data => {
        this.content = data;
      },
      err => {
